...
<link rel="stylesheet" href="<?php echo $_SESSION['SITE_URL'];?>/Admin/View/style.css" type="text/css" media="screen, projection" />
<link rel="stylesheet" href="<?php echo $_SESSION['SITE_URL'];?>/Admin/View/print.css" type="text/css" media="print" />
...
<body class="body-print">
	...
	<div class="header clearfix">
		<div class="logout-front no-print">
<?php 
