...
$path = $_SESSION['BASE_PATH'] . '/ZipDocuments/' . $_SESSION['UserId'] . '/temp/';
$mkpath = $_SESSION['BASE_PATH'] . '/ZipDocuments/' . $_SESSION['UserId'] . '/temp';
if (isset($_GET['stariZip']) && $_GET['stariZip'] != "obrisano") {
		unlink($path . $_GET['stariZip']);
}
			...
			if(strlen($name))
				{
					...
					//if($size<(1024*1024))
						...
						echo "Neispravan tip datoteke (Datoteka mora biti zip)..";	
				}
				
			else
				echo "Molimo odaberite zip datoteku ..!";
