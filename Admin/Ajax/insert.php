...
include_once $_SESSION['BASE_PATH']  . '/Admin/Ajax/projectVariable.php';
$data = array();
$pdfArray = array();
$imageArray = array();
...
echo "ovo je :" .$brojKatCestice . " fdff";
print_r($data_list);
if($uid !=""){
...
?>
<input type="hidden" value="<?php echo $lastProjectId; ?>" id="lastId" name="lastId" />
