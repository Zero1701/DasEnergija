...
if(isset($_GET['datumPotpisivanjaUgovora']) && strtotime($_GET['datumPotpisivanjaUgovora']) != false){ $datumPotpisivanjaUgovora = date("Y-m-d",strtotime($_GET['datumPotpisivanjaUgovora'])); $datumPotpisivanjaUgovora = stripslashes($datumPotpisivanjaUgovora); $datumPotpisivanjaUgovora = mysql_real_escape_string($datumPotpisivanjaUgovora); $datumPotpisivanjaUgovora = "'" . $datumPotpisivanjaUgovora . "'"; } else { $datumPotpisivanjaUgovora = "null"; }
