...
if (isset($_GET['staraSlika']) && $_GET['staraSlika'] != "obrisano") {
						...
						//{
							...
							if(move_uploaded_file($tmp, $path.$actual_image_name))
								...
								//mysql_query("UPDATE users SET profile_image='$actual_image_name' WHERE uid='$session_id'");
									...
									echo '<img class="slika" width="300" src="' . $_SESSION['SITE_URL'] . '/ProjectImage/' . $_SESSION['UserId'] . '/temp/' . $actual_image_name . '"  class="preview" />';
									?>
