...
<div class="oddp clearfix">
	...
	<div class="right">
		...
		<div id="pdf1prostorZaFormu"></div>
		<div id="previewposjedovniList" class="obrub prevdiv clearfix">
		...
		<?php } else { ?>
			<form id="pdfForm1" method="post" enctype="multipart/form-data" action='<?php echo $_SESSION['SITE_URL'];?>/User/Ajax/ajaxpdf.php?tip=pdf1'>
			<label>Posjedovni list (PDF): </label>
			<input type="file" name="pdf" id="posjedovniListFile" />
			</form>
			<div id="previewposjedovniList" class="obrub"></div>
		<?php }?>
		...
		<?php } else { ?>
		<form id="pdfForm2" method="post" enctype="multipart/form-data" action='<?php echo $_SESSION['SITE_URL'];?>/User/Ajax/ajaxpdf.php?tip=pdf2'>
			<label>Izvod iz katastarskog plana (PDF):</label> 
			<input type="file" name="pdf" id="izvodIzKatastarskogPlanaFile" />
		</form>
		<div id="previewizvodIzKatastarskogPlana" class="obrub"></div>
		<?php }?>
		...
		<div id="pdf3prostorZaFormu"></div>
		<div id="previewsatelitskaSnimkaProstora" class="obrub prevdiv clearfix">
		...
		<?php } else { ?>
		<form id="pdfForm3" method="post" enctype="multipart/form-data" action='<?php echo $_SESSION['SITE_URL'];?>/User/Ajax/ajaxpdf.php?tip=pdf3'>
			<label>Satelitska snimka prostora (PDF):</label> 
			<input type="file" name="pdf" id="satelitskaSnimkaProstoraFile" />
			<div id="previewsatelitskaSnimkaProstora" class="obrub"></div>
		</form>
		<?php } ?>
	</div><!--/right-->
</div><!--/oddp-->
...
<h4>Fotografije krova:</h4>
	...
	<div id="slika1prostorZaFormu"></div>
	...
	<div id="slika2prostorZaFormu"></div>
	<div id="previewslika2" class="obrub clearfix prevdiv">
	...
	<div id="slika3prostorZaFormu"></div>
	...
	<div id="slika4prostorZaFormu"></div>
	...
	<div id="previewslika5" class="obrub clearfix prevdiv">
...
<div class="oddp clearfix">
	<div class="left">
		...
		<input type="text" value="<?php echo date("d.m.Y.",strtotime(trim($td['DateOfContSigning'])));?>" name="datumPotpisivanjaUgovora" id="datumPotpisivanjaUgovora" class="small" />

		<label for="ugovoreniPostotak">Ugovoren postotak brutto prihoda za najam [%]: </label>
		<input type="text" value="<?php echo trim($td['PercentageOfGrossIncome']);?>" name="ugovoreniPostotak" id="ugovoreniPostotak" class="small" />
	</div>
	...
	<div class="right">
		...
		<div id="previewponuda" class="obrub clearfix prevdiv">
		...
		<?php } else { ?>
		<form id="pdfForm4" method="post" enctype="multipart/form-data" action='<?php echo $_SESSION['SITE_URL'];?>/User/Ajax/ajaxpdf.php?tip=pdf4'>
		...
		<div id="previewugovorSvlasnikom" class="obrub clearfix prevdiv">
		...
		<?php } else { ?>
		<form id="pdfForm5" method="post" enctype="multipart/form-data" action='<?php echo $_SESSION['SITE_URL'];?>/User/Ajax/ajaxpdf.php?tip=pdf5'>
			<label>Ugovor s vlasnikom (PDF):</label> 
