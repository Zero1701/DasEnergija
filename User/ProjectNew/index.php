...
<?php include_once $_SESSION['BASE_PATH']  . '/User/Class/projectUserTable.php';
include_once $_SESSION['BASE_PATH']  . '/User/View/newProjectTableView.php';
				  ...
				  jQuery('#spremi').click(function () {
				    ...
				    return false;
						...
						function spremi(){
							...
							jQuery.get("<?php echo $_SESSION['SITE_URL'];?>/User/Ajax/insert.php?" + $('#form1').serializeAnything(), {}, function(data){
