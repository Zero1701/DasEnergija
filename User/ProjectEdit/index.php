...
<?php include_once $_SESSION['BASE_PATH']  . '/User/Class/projectDetail.php';
...
include_once $_SESSION['BASE_PATH']  . '/User/View/editProjectTableView.php';
...
<?php //------------------------------------------------------------------------------------ ?>
		jQuery('#odustani').click(function () {
		  ...
		  function NewPage() {
			  document.location.href= "<?php echo $_SESSION['SITE_URL'];?>/User/index.php";
			}
		  <?php //------------------------------------------------------------------------------------ ?>
				  jQuery('#spremi').click(function () {
				    ...
				    return false;
						...
						function spremi(){
							...
							jQuery.get("<?php echo $_SESSION['SITE_URL'];?>/User/Ajax/update.php?" + $('#form1').serializeAnything(), {PID : <?php echo $ProjectId;?>}, function(data){
		...
		<?php //------------------------------------------------------------------------------------ ?>
				  ...
				  jQuery('#pdf5obrisi').click(function () {
				    ...
				    return false;
						...
						function forme(brojForme){
							...
							jQuery.get("<?php echo $_SESSION['SITE_URL'];?>/User/Ajax/pdfForma.php", {forma: brojForme }, function(data){
				  ...
				  function forme2(brojForme){
						...
						jQuery.get("<?php echo $_SESSION['SITE_URL'];?>/User/Ajax/slikaForma.php", {forma: brojForme }, function(data){
